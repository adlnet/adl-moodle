...
* remove folder theme/portal/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/portal/scss/bootstrap
...
* comment out this line in theme/portal/scss/_print.scss
    @page {
...
* remove folder theme/portal/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/portal/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/portal/amd/src
* edit theme/portal/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/portal run "grunt amd" to compile the bootstrap JS
* in folder theme/portal run "grunt css" to compile scss

...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_portal/drawers:show}
     * @property {String} drawerShown See {@link event:theme_portal/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_portal/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_portal/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_portal/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_portal/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_portal/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_portal/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_portal/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_portal/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_portal/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_portal/drawers:hidden',
    };
     ...
     * @returns {module:theme_portal/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_portal/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_portal/drawers:close');
     ...
     *
     * @param {module:theme_portal/drawers} comparisonInstance
     */

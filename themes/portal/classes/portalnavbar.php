...
/**
 * Creates a navbar for portal that allows easy control of the navbar items.
 *
 * @package    theme_portal
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class portalnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_portal();
    }

    /**
     * Prepares the navigation nodes for use with portal.
     */
    protected function prepare_nodes_for_portal(): void {
        global $PAGE;
    ...
    /**
     * Get all the portalnavbaritem elements.
     *
     * @return portalnavbaritem[] Portal navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this portal navbar
     */
    ...
    /**
     * Remove a portalnavbaritem from the portal navbar.
     *
     * @param  string|int $itemkey An identifier for the portalnavbaritem
     * @param  int|null $itemtype An additional type identifier for the portalnavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the portalnavbaritem.
     */
